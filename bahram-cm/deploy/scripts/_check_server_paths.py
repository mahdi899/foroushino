...
for cmd in [
    "ls -la /var/www/bahram-cm /var/www/foroushino/bahram-cm 2>&1",
    "pm2 list 2>&1",
    "readlink -f /var/www/bahram-cm 2>&1",
    "grep DEPLOY_APP /var/www/foroushino/bahram-cm/deploy/deploy.env 2>&1 || true",
]:
    print('===', cmd[:70], '===')
