...
export function ManifestoShift() {
  ...
  return (
    <section
      ...
      className="manifesto-section relative isolate overflow-hidden py-section-sm md:py-section"
    >
        ...
        <div className="grid items-center gap-10 md:gap-14 lg:grid-cols-12 lg:gap-16 xl:gap-20">
          ...
          <div className="order-1 lg:order-2 lg:col-span-7">
            <div className="manifesto-editorial relative overflow-hidden rounded-card-lg p-6 md:p-10 lg:p-12">
              ...
              <Reveal delay={0.45}>
                <div className="manifesto-signature relative z-[1] mt-8 flex items-center gap-3 pt-6 md:mt-10 md:gap-4 md:pt-8">
