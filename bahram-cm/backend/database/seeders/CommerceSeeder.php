...
HTML,
                ...
                'featured_image' => 'media/site/main-path-campaign.webp',
                'featured_image_mobile' => 'media/site/main-path-campaign.webp',
                'landing_hero_image' => 'media/site/landscape-session.webp',
                'landing_hero_image_mobile' => 'media/site/campaign-writing-hero-mobile.webp',
        ...
        Product::query()->updateOrCreate(
            ...
            [
                ...
                'type' => 'manual_service',
                'short_description' => 'از آموزش تا تماس، از تماس تا فروش — مسیر WAP.',
                'description' => '<p>سات؛ سیستم عملیاتی فروش تلفنی آکادمی بهرام.</p>',
                'price' => 200_000_000,
                'sale_price' => null,
                'is_active' => true,
                'show_on_courses' => true,
                'featured_listing' => false,
                'course_level' => 'سیستم عملیاتی',
                'course_duration' => 'مسیر WAP',
                'landing_href' => '/saat',
                'featured_image' => 'media/site/main-path-saat.webp',
                'featured_image_mobile' => 'media/site/main-path-saat.webp',
                'landing_hero_image' => 'media/site/saat-hero.webp',
                'landing_hero_image_mobile' => 'media/site/saat-hero.webp',
                'meta_title' => 'سات · سیستم عملیاتی فروش | بهرام رستمی',
                'meta_description' => 'سات؛ سیستم عملیاتی فروش. از آموزش تا تماس، از تماس تا کمیسیون — مسیر WAP.',
            ],
        );
