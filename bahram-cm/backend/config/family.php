...
return [
    ...
    'feed' => [
        'per_page' => 15,
        'guest_preview_posts' => (int) env('FAMILY_GUEST_PREVIEW_POSTS', 6),
    ...
    'cache' => [
        ...
        'feed_cursor_ttl' => (int) env('FAMILY_CACHE_FEED_CURSOR_TTL', 60),
        'pinned_ttl' => (int) env('FAMILY_CACHE_PINNED_TTL', 60),
