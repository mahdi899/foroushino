...
enum SmsEventKey: string
{
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::IdentityVerificationApproved => 'پیامک تأیید احراز هویت توسط کارشناس',
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::IdentityVerificationApproved => 'پس از تأیید مدارک توسط کارشناس در پنل احراز هویت',
