    ...
    public static function defaults(): array
    {
        ...
        $cache = [
            ...
            'registration_ask_mobile' => [
                ...
                'category' => 'ثبت‌نام',
                'body' => $e('phone').' <b>شماره موبایل</b>'.$nl.$nl.'دکمه «ارسال شماره تماس» را بزنید یا شماره را تایپ کنید.',
            ],
            'registration_ask_name' => [
                'label' => 'درخواست نام',
                'category' => 'ثبت‌نام',
                'body' => $e('pen').' <b>نام و نام خانوادگی</b>'.$nl.$nl.'لطفاً نام کامل خود را بنویسید.',
            ],
