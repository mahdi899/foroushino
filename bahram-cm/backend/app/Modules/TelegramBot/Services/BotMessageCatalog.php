...
class BotMessageCatalog
{
    ...
    public const DEFAULTS = [
        ...
        'seminars_catalog_empty' => [
            'label' => 'سمینار خالی',
            'category' => 'خرید',
            'body' => "📭 <b>سمینار فعالی نیست</b>\n\nبه‌محض اعلام رویداد جدید اینجا نمایش داده می‌شود.",
        ],
        'support_prompt' => [
            'label' => 'شروع پشتیبانی',
            'category' => 'پشتیبانی',
