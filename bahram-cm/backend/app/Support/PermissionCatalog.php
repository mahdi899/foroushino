...
final class PermissionCatalog
{
    ...
    public static function groups(): array
    {
        return [
            ...
            'Telegram' => [
                ...
                'telegram.manage',
                'telegram.users.view',
                'telegram.users.reveal_mobile',
                'telegram.users.unlink',
                'telegram.content.manage',
                'telegram.legal.manage',
                'telegram.required_chats.manage',
                'telegram.destinations.manage',
                'telegram.broadcast.create',
                'telegram.broadcast.test',
                'telegram.broadcast.approve',
                'telegram.broadcast.stop',
                'telegram.support.manage',
                'telegram.operators.manage',
                'telegram.reports.view',
                'telegram.financial_reports.view',
                'telegram.settings.manage',
                'telegram.logs.view',
                'telegram.impersonate',
            ],
        ];
    }
    ...
    public static function label(string $permission): string
    {
        return match ($permission) {
            ...
            'telegram.manage' => 'مدیریت ربات تلگرام',
            'telegram.users.view' => 'مشاهده کاربران تلگرام',
            'telegram.users.reveal_mobile' => 'نمایش شماره کامل کاربران تلگرام',
            'telegram.users.unlink' => 'قطع اتصال حساب تلگرام',
            'telegram.content.manage' => 'مدیریت محتوای ربات',
            'telegram.legal.manage' => 'مدیریت قوانین ربات',
            'telegram.required_chats.manage' => 'مدیریت کانال‌های اجباری',
            'telegram.destinations.manage' => 'مدیریت مقاصد تلگرامی',
            'telegram.broadcast.create' => 'ایجاد پیام همگانی',
            'telegram.broadcast.test' => 'ارسال تست همگانی',
            'telegram.broadcast.approve' => 'تأیید پیام همگانی',
            'telegram.broadcast.stop' => 'توقف پیام همگانی',
            'telegram.support.manage' => 'مدیریت پشتیبانی تلگرام',
            'telegram.operators.manage' => 'مدیریت اپراتورهای تلگرام',
            'telegram.reports.view' => 'مشاهده گزارش‌های ربات',
            'telegram.financial_reports.view' => 'مشاهده گزارش مالی ربات',
            'telegram.settings.manage' => 'مدیریت تنظیمات ربات',
            'telegram.logs.view' => 'مشاهده لاگ‌های ربات',
            'telegram.impersonate' => 'امپرسونیت فلو ربات',
            default => $permission,
        };
    }
}
