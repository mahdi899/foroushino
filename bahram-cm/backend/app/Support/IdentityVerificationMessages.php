...
final class IdentityVerificationMessages
{
    ...
    public const DAILY_SUBMIT_LIMIT =
        'سقف ارسال درخواست احراز هویت برای امروز تکمیل شده است (حداکثر ۲ بار در روز). فردا دوباره تلاش کنید.';

    public const IDENTITY_MISMATCH =
        'اطلاعات هویتی اشتباه است. نام، کد ملی یا تاریخ تولد با استعلام رسمی مطابقت ندارد. لطفاً اطلاعات را اصلاح و دوباره ارسال کنید.';

    public const MOBILE_NATIONAL_MISMATCH =
        'شماره موبایل ثبت‌شده با کد ملی واردشده مطابقت ندارد. درخواست احراز هویت رد شد. با شمارهٔ متعلق به همان کد ملی وارد شوید یا کد ملی صحیح را وارد کنید.';
