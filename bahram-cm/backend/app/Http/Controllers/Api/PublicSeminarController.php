        ...
        $cached = RuntimeCache::remember(
            ...
            function () use ($slug) {
                ...
                return [
                    ...
                    'cover_image' => $coverRef ? MediaUrl::resolve($coverRef, absolute: false) : null,
                    'cover_image_mobile' => $coverMobileRef ? MediaUrl::resolve($coverMobileRef, absolute: false) : null,
