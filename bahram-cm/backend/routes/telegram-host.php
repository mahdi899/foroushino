...
Route::middleware(['proxy.origin:presence', 'telegram.host.signature', 'throttle:120,1'])
    ...
    ->group(function (): void {
        ...
        Route::post('/registration/upsert', [TelegramHostSyncController::class, 'registrationUpsert'])->middleware('throttle:30,1');
        Route::post('/registration/probe', [TelegramHostSyncController::class, 'registrationProbe'])->middleware('throttle:60,1');
        ...
        Route::prefix('live')->group(function (): void {
            ...
            Route::post('/checkout/zarinpal/start', [TelegramHostLiveController::class, 'checkoutZarinpalStart'])->middleware('throttle:120,1');
            Route::post('/checkout/c2c/start', [TelegramHostLiveController::class, 'checkoutC2cStart'])->middleware('throttle:120,1');
