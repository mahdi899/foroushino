/** Shared `sizes` hints for next/image — keeps CDN requests close to rendered width. */
export const IMAGE_SIZES = {
  ...
  /** 3-column card grid — cap to avoid w=750 on small tiles. */
...
/** Max delivery width — avoids ?w=3840 on large monitors. */
