...
export const sales: Sale[] = [
  ...
  },
  {
    ...
    paymentMethod: 'gateway',
    createdAt: at(-2 * DAY),
    submittedAt: at(-2 * DAY + HOUR),
    confirmedAt: at(-1 * DAY),
    confirmedBy: 'a-mgr',
  },
  {
    id: 'sale-7',
...
export const commissions: Commission[] = [
  ...
  },
  {
    ...
    status: 'approved',
    createdAt: at(-3 * DAY),
    leaderApprovedAt: at(-2 * DAY + HOUR),
    approvedAt: at(-2 * DAY),
    availableAt: at(1 * DAY),
  },
  {
  ...
  },
  {
    ...
    commissionAmount: 2_700_000,
    status: 'pending',
    createdAt: at(-12 * HOUR),
    availableAt: at(3 * DAY),
  },
]
