    ...
    public function requestPhoneOtp(RequestPhoneOtpRequest $request): JsonResponse
    {
        ...
        return ApiResponse::success([
            ...
            'hint' => match ($channel) {
                ...
                'choice' => 'رمز عبور یا کد تأیید را انتخاب کنید.',
                'sms' => 'کد ورود به شماره موبایلت پیامک شد.',
                'telegram' => 'کد ورود به تلگرامت ارسال شد.',
                default => 'کد تأیید ارسال شد.',
            },
        ], match ($channel) {
            'demo' => 'کد دمو آماده است.',
            'password' => 'ورود با رمز عبور',
            'choice' => 'روش ورود را انتخاب کنید',
            'sms' => 'کد ورود پیامک شد.',
            'telegram' => 'کد ورود به تلگرامت ارسال شد.',
            default => 'کد تأیید ارسال شد.',
        });
    }
